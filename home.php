                  ...
                  <!-- Panel heading -->
                   <div class="panel-heading">
                    <h4 class="panel-title">
                      ...
                      <i class="fa fa-angle-right"></i>HIRING NEW HR </a></h4>
                   </div>
                   <div id="collapseOne-alt3" class="panel-collapse collapse">
                    <!-- Panel body -->
                    <div class="panel-body">
                      <p>HR Recruiter responsibilities include <strong>sourcing candidates online, updating job ads and conducting background checks</strong>. If you have experience with various job interview formats, including phone screenings and group interviews, and can help us recruit faster and more effectively, we'd like to meet you.</p>
                      <p>&nbsp;</p>
                    </div>
                   </div>
                  </div>
                  <div class="panel">
                   <div class="panel-heading">
                    <h4 class="panel-title">
                      ...
                      <i class="fa fa-angle-right"></i>TAKING  FRESHERS</a></h4>
                   </div>
                   <div id="collapseTwo-alt3" class="panel-collapse collapse">
                    <div class="panel-body"><strong>A meticulous and organized individual seeking an Entry-level position in the field of Project Management</strong>. Skilled at developing reports, analyzing data, and identifying solutions. Strong ability to handle complex projects. Innovative, creative, and willing to contribute ideas and learn new things.</div>
                   </div>
                  </div>
                  <div class="panel">
                   <div class="panel-heading">
                    <h4 class="panel-title">
                      ...
                      <i class="fa fa-angle-right"></i>NEW VACANCY COMING</a></h4>
                   </div>
                   <div id="collapseThree-alt3" class="panel-collapse collapse">
                    <div class="panel-body">New jobs and vacancy are coming...Be update</div>
                   </div>
                  </div>
                  <div class="panel">
