...
<head>
<meta charset="utf-8">
<title>LinkedOut / <?php echo $title;?></title>
  ...
  <header>
        <div class="topbar navbar-fixed-top">
          <div class="container">
            <div class="row">
              <div class="col-md-12">      
                <p class="pull-left hidden-xs"><i class="fa fa-phone"></i>Mobile No. 9150603489</p>
        ...
        <div class="navbar navbar-default navbar-static-top" > 
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo web_root; ?>index.php">LINKEDOUT<!-- <img src="<?php echo web_root; ?>plugins/home-plugins/img/logo.png" alt="logo"/> --></a>
                </div>
    ...
    <div class="row">
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          ...
          JC Main Road, Cuddalore,TamilNAdu<br>
           Pin-607807.</address>
          <p>
            <i class="icon-phone"></i> 9150603489 <br>
            <i class="icon-envelope-alt"></i> linkedout123@gmail.com
          </p>
        </div>
      </div>
      <div class="col-md-4 col-sm-4">
